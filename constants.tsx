...
export const STORY_DATA: Record<string, StoryNode> = {
  ...
  'linchong_demo_9': { id: 'linchong_demo_9', speaker: '{playerName}', content: '你试探着开口：“大师，我曾听过些传闻……说林教头当年在山神庙手刃仇人，火并王伦，是何等英雄了得。难道……那些都不是真的吗？”', background: BG_BAMBOO, nextId: 'linchong_demo_10' },
  'linchong_demo_10': { id: 'linchong_demo_10', speaker: '鲁智深', characterId: 'luzhishen', content: '鲁智深闻言，苦笑着摇了摇头：“英雄？洒家倒希望那是真的。可现实是，那贼人陆谦至今还在京城享着荣华富贵。”', background: BG_BAMBOO, nextId: 'linchong_demo_10_1' },
  'linchong_demo_10_1': { id: 'linchong_demo_10_1', speaker: '鲁智深', characterId: 'luzhishen', content: '“至于那王伦，林兄弟上山后受尽了他的百般刁难，却始终逆来顺受。最后是那赤发鬼刘唐看不下去，一刀结果了那厮。”', background: BG_BAMBOO, nextId: 'linchong_demo_11' },
  'linchong_demo_11': { id: 'linchong_demo_11', speaker: '{playerName}', content: '你一边听着鲁大师的讲述，一边在心里暗自思忖：这和书里写的一点都不一样。', background: BG_BAMBOO, nextId: 'linchong_demo_12' },
  'linchong_demo_12': { id: 'linchong_demo_12', speaker: '{playerName}', content: '这个世界的“豹子头”，竟然被现实磨平了所有棱角。这和你记忆中那个快意恩仇的英雄完全不同。', background: BG_BAMBOO, nextId: 'linchong_demo_13' },
